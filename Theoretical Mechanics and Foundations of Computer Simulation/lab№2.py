...
Point_A = ax.plot(X_A[0], Y_A[0], marker='o', color='blue')[0] #построение точки центра масс тела
Point_B = ax.plot(X_B[0], Y_B[0], marker='o', markersize=10, color='red')[0] #построение точечного груза

#Построение графика зависимости абциссы точки центра масс тела от параметра t
...
#Построение графика зависимости ординаты точки центра масс тела от параметра t
...
#Построение графика зависимости абциссы точки центра масс точечного груза от параметра t
...
#Построение графика зависимости ординаты точки центра масс точечного груза от параметра t
